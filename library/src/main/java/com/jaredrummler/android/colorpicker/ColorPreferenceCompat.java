...
public class ColorPreferenceCompat extends Preference implements ColorPickerDialogListener {
    ...
    @StringRes
    private int dialogPresetsActionText;
    @StringRes
    private int dialogSelectActionText;
    @StringRes
    private int dialogCustomActionText;
    @StringRes
    private int dialogTransparencyActionText;
    ...
    private void init(AttributeSet attrs) {
        ...
        dialogPresetsActionText = a.getResourceId(R.styleable.ColorPreference_cpv_dialogPresetsActionText, R.string.cpv_presets);
        dialogSelectActionText = a.getResourceId(R.styleable.ColorPreference_cpv_dialogSelectActionText, R.string.cpv_select);
        dialogCustomActionText = a.getResourceId(R.styleable.ColorPreference_cpv_dialogCustomActionText, R.string.cpv_custom);
        dialogTransparencyActionText = a.getResourceId(R.styleable.ColorPreference_cpv_dialogTransparencyActionText, R.string.cpv_transparency);
        if (presetsResId != 0) {
    ...
    protected void onClick() {
        ...
        if (onShowDialogListener != null) {
            ...
            ColorPickerDialog dialog = ColorPickerDialog.newBuilder()
                    ...
                    .setPresetsButtonText(dialogPresetsActionText)
                    .setSelectedButtonText(dialogSelectActionText)
                    .setTransparencyButtonText(dialogTransparencyActionText)
                    .setCustomButtonText(dialogCustomActionText)
