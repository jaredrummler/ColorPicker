...
public class ColorPickerDialog extends DialogFragment implements ColorPickerView.OnColorChangedListener, TextWatcher {
    ...
    private static final String ARG_TRANSPARENCY_BUTTON_TEXT = "transparencyButtonText";
    ...
    View createPresetsView() {
        ...
        final TextView transparencyTitle = (TextView) contentView.findViewById(R.id.transparency_title);
        int transparencyButtonStringRes = getArguments().getInt(ARG_TRANSPARENCY_BUTTON_TEXT);
        if (transparencyButtonStringRes == 0)
            transparencyButtonStringRes = R.string.cpv_transparency;
        transparencyTitle.setText(transparencyButtonStringRes);
        ...
        if (showAlphaSlider) {
            ...
            transparencyTitle.setVisibility(View.GONE);
        }
    ...
    public static final class Builder {
        ...
        @StringRes
        int transparencyButtonText = R.string.cpv_transparency;
        @DialogType
        ...
        /**
         * Set the transparency button text string resource id
         *
         * @param transparencyButtonText The string resource used for the transparency button text
         * @return This builder object for chaining method calls
         */
        public Builder setTransparencyButtonText(@StringRes int transparencyButtonText) {
        ...
        public ColorPickerDialog create() {
            ...
            args.putInt(ARG_TRANSPARENCY_BUTTON_TEXT, transparencyButtonText);
