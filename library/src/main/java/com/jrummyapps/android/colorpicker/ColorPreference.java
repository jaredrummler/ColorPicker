...
public class ColorPreference extends Preference implements ColorPickerDialogListener {
  ...
  private void init(AttributeSet attrs) {
    ...
    showDialog = a.getBoolean(R.styleable.ColorPreference_jrcc_showDialog, true);
    //noinspection WrongConstant
    dialogType = a.getInt(R.styleable.ColorPreference_jrcc_dialogType, ColorPickerDialog.TYPE_PRESETS);
    colorShape = a.getInt(R.styleable.ColorPreference_jrcc_colorShape, ColorShape.CIRCLE);
    allowPresets = a.getBoolean(R.styleable.ColorPreference_jrcc_allowPresets, true);
    allowCustom = a.getBoolean(R.styleable.ColorPreference_jrcc_allowCustom, true);
    showAlphaSlider = a.getBoolean(R.styleable.ColorPreference_jrcc_showAlphaSlider, false);
    showColorShades = a.getBoolean(R.styleable.ColorPreference_jrcc_showColorShades, true);
    previewSize = a.getInt(R.styleable.ColorPreference_jrcc_previewSize, SIZE_NORMAL);
    final int presetsResId = a.getResourceId(R.styleable.ColorPreference_jrcc_colorPresets, 0);
    dialogTitle = a.getResourceId(R.styleable.ColorPreference_jrcc_dialogTitle, R.string.cpv_default_title);
    if (presetsResId != 0) {
