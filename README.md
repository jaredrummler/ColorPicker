...
<a target="_blank" href="http://www.methodscount.com/?lib=com.jaredrummler%3Acolorpicker%3A1.0.4"><img src="https://img.shields.io/badge/methods-409-e91e63.svg" /></a>
...
Download [the latest AAR](https://repo1.maven.org/maven2/com/jaredrummler/colorpicker/1.0.4/colorpicker-1.0.4.aar) or grab via Gradle:

```groovy
implementation 'com.jaredrummler:colorpicker:1.0.4'
```
or Maven:
```xml
<dependency>
